...
public class Main extends JFrame implements MouseListener {
	...
	public static void FillArrays() {
		...
		for (int w = 0; w < 8;) {
			switch (state) {
			case 'A':
				ranNum = (int) (Math.floor(Math.random() * 8));
				state = 'B';
				break;
			case 'B':
				if (WhiteArray.contains(ranNum)) {
					state = 'A';
				} else {
					WhiteArray.add(ranNum);
					w++;
					state = 'A';
				}
				break;
		...
		for (int b = 0; b < 8;) {
			...
			case 'A':
				...
				break;
			case 'B':
				if (BlackArray.contains(ranNum)) {
					state = 'A';
				} else {
					BlackArray.add(ranNum);
					b++;
					state = 'A';
				}
				break;
	...
	public Main() {
		...
		if (!rButton.isEnabled()) {
			...
			for (int i = 0; i < 8; i++)
				for (int j = 0; j < 8; j++) {
					P = null;
					if (i == 0 && j == BlackArray.get(0))
						P = br01;
					else if (i == 0 && j == BlackArray.get(1))
						P = br02;
					else if (i == 7 && j == WhiteArray.get(0))
						P = wr01;
					else if (i == 7 && j == WhiteArray.get(1))
						P = wr02;
					else if (i == 0 && j == BlackArray.get(2))
						P = bk01;
					else if (i == 0 && j == BlackArray.get(3))
						P = bk02;
					else if (i == 7 && j == WhiteArray.get(2))
						P = wk01;
					else if (i == 7 && j == WhiteArray.get(3))
						P = wk02;
					else if (i == 0 && j == BlackArray.get(4))
						P = bb01;
					else if (i == 0 && j == BlackArray.get(5))
						P = bb02;
					else if (i == 7 && j == WhiteArray.get(4))
						P = wb01;
					else if (i == 7 && j == WhiteArray.get(5))
						P = wb02;
					else if (i == 0 && j == BlackArray.get(6))
						P = bk;
					else if (i == 0 && j == BlackArray.get(7))
						P = bq;
					else if (i == 7 && j == WhiteArray.get(6))
						P = wk;
					else if (i == 7 && j == WhiteArray.get(7))
						P = wq;
					else if (i == 1)
						P = bp[j];
					else if (i == 6)
